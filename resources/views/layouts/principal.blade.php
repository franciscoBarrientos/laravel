...
<head>
    ...
    <!-- comments to use a laravel collective include styles
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">
                        <i class="glyphicon glyphicon-user"></i> Administrar
                        <span class="caret"></span>
                    </a>
                    <ul id="g-account-menu" class="dropdown-menu" role="menu">
                        <li><a href="/usuario/{!!Auth::user()->id!!}/edit">Mi cuenta</a></li>
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="nav nav-stacked">
                <li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#userMenu">Atención <i class="glyphicon glyphicon-chevron-down"></i></a>
                    <ul class="nav nav-stacked collapse in" id="userMenu">
                        ...
                        <li class="nav-header"><a href="#" data-toggle="collapse" data-target="#subMenu"><i class="glyphicon glyphicon-user"></i> Clientes</a>
                            <ul class="nav navbar-stacked collapse" id="subMenu">
                                <li>
                                    <a href="/cliente/create">Crear cliente</a>
                                </li>
                                <li>
                                    <a href="/cliente">Editar clientes</a>
                                </li>
                            </ul>
                        </li>
